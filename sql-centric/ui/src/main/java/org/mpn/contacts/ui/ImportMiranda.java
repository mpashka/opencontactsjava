 ...
 * @version $Revision$
 */
public class ImportMiranda extends Importer {
...
//        log.debug("Contact : " + contactName + ", properties :" + contactProperties);
        ...
        String contactName = contactProperties.get("CList").getString("MyHandle");
    ...
    protected Charset determineLineCharset(byte[] lineBytes, int offset, int length) {
        ...
        return unicode ? ImportMiranda.UTF8_CHARSET : ImportMiranda.DEFAULT_CHARSET;
    }
